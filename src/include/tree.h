...
typedef struct TreeNode {
    ...
    struct TreeNode *parent;        // Pointer ke parent
    struct TreeNode *first_child;   // Pointer ke anak pertama
    struct TreeNode *next_sibling;  // Pointer ke saudara berikutnya
} TreeNode;

// Struktur manajer tree untuk menyimpan semua node
typedef struct {
    TreeNode *nodes[100];           // Array pointer ke semua node
